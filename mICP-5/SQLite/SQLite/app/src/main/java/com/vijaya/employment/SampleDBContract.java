...
public final class SampleDBContract {
    ...
    public static final String SELECT_EMPLOYEE_WITH_EMPLOYER_BASED_ON_ID = "SELECT * " +
            "FROM " + Employee.TABLE_NAME + " ee INNER JOIN " + Employer.TABLE_NAME + " er " +
            "ON ee." + Employee.COLUMN_EMPLOYER_ID + " = er." + Employer._ID + " WHERE " +
            "ee." + Employee.ID + " = ? ";
    public static final String SELECT_EMPLOYEE_WITH_ID = "SELECT * " +
            "FROM " + Employee.TABLE_NAME + " ee WHERE " +
            "ee." + Employee.ID + " = ? ";
    public static final String SELECT_EMPLOYER_WITH_ID = "SELECT * " +
            "FROM " + Employer.TABLE_NAME + " er WHERE " +
            "er." + Employer._ID + " = ? ";
    public static final String SELECT_EMPLOYEE = "SELECT * " +
            "FROM " + Employee.TABLE_NAME + " ee INNER JOIN " + Employer.TABLE_NAME + " er " +
